...
<div class="footer">
	<div class="footer_list">
		...
		<a href="/wap/activity/commneet/${activity.id}.asp"  class="footer_list_item">
			<div style="text-align: center;"><img style="width: 20px;" src="/static/images/vote/pinglun.png"></div>
			<div class="footer_list_item_name">评论</div>
		</a>
